                    ...
                    <el-row>
                        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                            <el-form-item label="端口开始" prop="min">
                                <el-tooltip class="box-item" effect="dark" content="端口开始" placement="top-start">
                                    <el-input size="default" v-model="model.min" placeholder="端口开始"></el-input>
                                </el-tooltip>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                            <el-form-item label="端口结束" prop="max">
                                <el-tooltip class="box-item" effect="dark" content="端口结束" placement="top-start">
                                    <el-input size="default" v-model="model.max" placeholder="端口结束"></el-input>
                                </el-tooltip>
                            </el-form-item>
                        </el-col>
                    </el-row>
    ...
    setup() {
        ...
        const loadConfig = () => {
            return new Promise((resolve, reject) => {
                getConfigure('ServerUdpForwardConfigure').then((json) => {
            ...
            return new Promise((resolve, reject) => {
                formDom.value.validate((valid) => {
                    ...
                    loadConfig().then((json) => {
                        ...
                        saveConfigure('ServerUdpForwardConfigure', JSON.stringify(json)).then(resolve).catch(reject);
                    }).catch(reject);
                });
            })
        }
