 ...
 * @LastEditors: snltty
 * @LastEditTime: 2023-02-12 21:04:34
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.service.ui.web\src\views\setting\Client.vue
-->
<template>
                    ...
                    <el-row>
                        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                            <el-form-item label="自动注册" prop="AutoReg">
                                <el-checkbox size="default" v-model="model.AutoReg">自动注册</el-checkbox>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                        ...
                        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                            <el-form-item label="自动中继" prop="AutoRelay">
                                <el-tooltip class="box-item" effect="dark" content="不开启自动打洞的话，是否自动中继" placement="top-start">
                                    <el-checkbox v-model="model.AutoRelay">自动中继</el-checkbox>
                                </el-tooltip>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
