 ...
 * @LastEditors: snltty
 * @LastEditTime: 2023-02-12 19:06:46
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.service.ui.web\src\views\setting\Socks5.vue
-->
<template>
        ...
        const state = reactive({
            ...
            rules: {
                ...
                BufferSize: [
                    { required: true, message: '必填', trigger: 'blur' },
                    {
                        type: 'number', min: 1024, max: 1048576, message: '数字 1024-1048576', trigger: 'blur', transform (value) {
                            return Number(value)
                        }
                    }
                ],
