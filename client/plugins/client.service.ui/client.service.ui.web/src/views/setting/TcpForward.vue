 ...
 * @LastEditors: snltty
 * @LastEditTime: 2023-02-12 20:33:08
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.service.ui.web\src\views\setting\TcpForward.vue
-->
<template>
    <div class="form">
        <div class="inner">
        ...
        const state = reactive({
            ...
            rules: {
                BufferSize: [
                    ...
                    {
                        type: 'number', min: 1024, max: 2147483647, message: '数字 1024-2147483647', trigger: 'blur', transform (value) {
                            return Number(value)
                        }
                    }
                ]
