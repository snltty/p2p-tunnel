...
dotnet publish ./client/client.service.app -c:Release -f:net6.0-android33.0 /p:AndroidSigningKeyPass=123321 /p:AndroidSigningStorePass=123321  /p:AndroidSdkDirectory=%sdkpath%
echo F|xcopy "client\\client.service.app\\bin\\Release\\net6.0-android33.0\\publish\\p2p_tunnel.p2p_tunnel-Signed.apk" "public\\publish-zip\\p2p-tunnel.apk"  /s /f /h /y
